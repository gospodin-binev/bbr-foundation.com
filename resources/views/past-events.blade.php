...
<!-- Title -->
<title>Past events | BBR Foundation</title>
...
<header id="header" class="header-horizontal dark">
    ...
    <ul class="social-icons pull-right margin-b-0 hidden-xs">
        <li><a href="https://www.facebook.com/bbrfdn" target="_blank" class="icon icon-xs"><i class="fa fa-facebook"></i></a></li>
    </ul>
    ...
    <div class="posts-list">
        ...
        @foreach ($past_events as $past_event)
            ...
            <div class="post section bg-blue-dark dark" data-header-change="true">
                ...
                <div class="image">
                    <div class="bg-image"><img src="{{ $past_event->image }}" alt=""></div>
                </div>

                <div class="content">
                    <h1><a href="{{ url('/past-event') }}/{{ $past_event->id }}">{{ $past_event->title }} </a></h1>
                    <a href="{{ url('/past-event') }}/{{ $past_event->id }}" class="link-default">Read more</a>
                </div>
