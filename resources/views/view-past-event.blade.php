...
<!-- Title -->
<title>{{ $past_event->title }} | BBR Foundation</title>
	...
	<div class="container">
		<div style="margin-top: 50px;" class="row margin-b-50">
			<div class="col-lg-8 col-lg-offset-1">
				<h1>{{ $past_event->title }}</h1>

				<div class="margin-b-80">
					<img src="{{ $past_event->image }}" class="img-responsive margin-b-10" alt="">
				</div>

				<span class="lead">{!! $past_event->content !!}</span>
			</div>
		</div>
	</div>
	
	<!-- Close -->
	<a href="/past-events" class="ajax-close x-close" data-dismiss="close"></a>
</div>
